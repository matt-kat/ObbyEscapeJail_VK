...
function initializeBridge() {
    ...
    bridge
        ...
        .then(() => {
            ...
            unityLoader.src = 'Build/ObbyEscapeJail_VK.loader.js'
            unityLoader.onload = () => {
                createUnityInstance(
                    CANVAS,
                    {
                        dataUrl: 'Build/ObbyEscapeJail_VK.data.unityweb',
                        frameworkUrl: 'Build/ObbyEscapeJail_VK.framework.js.unityweb',
                        codeUrl: 'Build/ObbyEscapeJail_VK.wasm.unityweb',
                        streamingAssetsUrl: 'StreamingAssets',
                        companyName: 'DefaultCompany',
                        productName: 'Obby_Jail',
